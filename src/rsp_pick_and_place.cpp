...
void RspPickandPlace::initServiceClient()
{
...
void RspPickandPlace::initSubscribe()
{
  open_manipulator_states_sub_ = node_handle_.subscribe("states", 10, &RspPickandPlace::manipulatorStatesCallback, this);
  open_manipulator_joint_states_sub_ = node_handle_.subscribe("joint_states", 10, &RspPickandPlace::jointStatesCallback, this);
  open_manipulator_kinematics_pose_sub_ = node_handle_.subscribe("gripper/kinematics_pose", 10, &RspPickandPlace::kinematicsPoseCallback, this);
  ar_pose_marker_sub_ = node_handle_.subscribe("/ar_pose_marker", 10, &RspPickandPlace::arPoseMarkerCallback, this);
}

bool RspPickandPlace::setJointSpacePath(std::vector<std::string> joint_name, std::vector<double> joint_angle, double path_time)
{
...
bool RspPickandPlace::setToolControl(std::vector<double> joint_angle)
{
  open_manipulator_msgs::SetJointPosition srv;
...
void RspPickandPlace::manipulatorStatesCallback(const open_manipulator_msgs::OpenManipulatorState::ConstPtr &msg)
{
...
void RspPickandPlace::jointStatesCallback(const sensor_msgs::JointState::ConstPtr &msg)
{
...
void RspPickandPlace::kinematicsPoseCallback(const open_manipulator_msgs::KinematicsPose::ConstPtr &msg)
{
...
void RspPickandPlace::demoSequence()
{
  std::vector<double> joint_angle;
...
void RspPickandPlace::printText()
{
  system("clear");
...
// callback for keyboard hit while running publishCallback
bool RspPickandPlace::kbhit()
{
  termios term;
  tcgetattr(0, &term);
